...
const Blogs = () => {
	...
	return (
		<div className="container mx-auto p-6">
			...
			<a
				href="https://chat.whatsapp.com/HXTxpAjzHHwA9ZNBisFJWd"
				target="_blank"
				rel="noopener noreferrer"
				className="px-6 py-3 bg-green-500 text-white font-semibold rounded-md hover:bg-green-600 transition mb-10"
			>
				Join A Community
			</a>
